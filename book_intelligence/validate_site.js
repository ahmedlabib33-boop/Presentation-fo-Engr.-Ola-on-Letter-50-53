...
assert(/const PROTECTION_CORRESPONDENCE_CHAIN=\[/.test(letter53Upgrade) && /protection-letter050/.test(letter53Upgrade) && /protection-letter104/.test(letter53Upgrade) && /protection-letter053/.test(letter53Upgrade) && /protection-chain-question/.test(letter53Upgrade) && /protection-chain-conclusion/.test(letter53Upgrade), 'The 050 to 104 to 053 correspondence chain is missing');
assert(/const PROTECTION_CORRESPONDENCE_CHAIN_AR=\[/.test(letter53Upgrade) && /موقف سامكو في STR-104/.test(letter53Upgrade) && /خلاصة التسلسل 050 ← 104 ← 053/.test(letter53Upgrade), 'Arabic 050 to 104 to 053 correspondence chain is missing');
assert(/protection-samco-position/.test(letter53Upgrade) && /protection-protected-conclusion/.test(letter53Upgrade), 'SAMCO position and Protected point cards were not preserved');
